...
public class BlockTFCompressor extends Block {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
	private static boolean keepInventory;
    public BlockTFCompressor() {
        super(Material.IRON);
    ...
    {
        return Item.getItemFromBlock(BlockLoader.TFCOMPRESSOR);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            if (tileentity instanceof TileEntityTFCompressor) {
                    playerIn.openGui(TofuMain.instance, TofuGuiHandler.ID_TFCOMPRESSOR_GUI, worldIn, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
    }
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityTFCompressor();
    }
